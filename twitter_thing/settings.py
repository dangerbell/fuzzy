# Django settings for twitter_thing project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'twitter_thing',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '#9qcr0yk!-l=lmz_n7kwpr8wi%pha*a55*jv!ute&amp;)8_c$)g6*'
...
ROOT_URLCONF = 'twitter_thing.urls'
